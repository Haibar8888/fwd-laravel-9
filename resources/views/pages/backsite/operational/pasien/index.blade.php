                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="title" name="title" class="form-control" placeholder="example sakit lambung or jantung sesak" value="{{old('title')}}" autocomplete="off" required>
                                                    ...
                                                    <tbody>
                                                        @forelse($pasiens as $pasien)
                                                            <tr data-entry-id="{{ $pasien->id }}">
                                                                <td>{{ isset($pasien->created_at) ? date("d/m/Y H:i:s",strtotime($pasien->created_at)) : 'Tanggal tidak ada' }}</td>
                                                                <td>{{ $pasien->nama ?? '' }}</td>
                                                                <td>{{ $pasien->usia ?? '' }}</td>
                                                                <td>{{ $pasien->jenis_kelamin ?? '' }}</td>
                                                                <td>{{ $pasien->asal_rs ?? '' }}</td>
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('consultation_show')
                                                                                <a href="#mymodal"
                                                                                    data-remote="{{ route('backsite.pasien.show', $pasien->id) }}"
                                                                                    data-toggle="modal"
                                                                                    data-target="#mymodal"
                                                                                    data-title="Prioritas Detail"
                                                                                    class="dropdown-item">
                                                                                    Show
                                                                                </a>
                                                                            @endcan
                                                                            ...
                                                                            @can('consultation_edit')
                                                                                <a class="dropdown-item" href="{{ route('backsite.pasien.edit', $pasien->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan

                                                                            @can('consultation_delete')
                                                                                <form action="{{ route('backsite.pasien.destroy', $pasien->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
