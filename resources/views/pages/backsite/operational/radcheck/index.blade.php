                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.radcheck.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="username" name="username" class="form-control" placeholder="username" value="{{old('username')}}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="password" id="password" name="password" class="form-control" placeholder="password" value="{{old('password')}}" autocomplete="off" required>
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('consultation_delete')
                                                                                <form action="{{ route('backsite.radcheck.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
